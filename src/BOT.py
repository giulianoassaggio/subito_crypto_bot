...
CHAT_ID_GRUPPO = -1397315169    # subito_crypto
CHAT_ID_VETRINA = -1872734100    # subito_crypto_vetrina
CHAT_ID_FEEDBACK = -1956565384   # subito_crypto_feedbacks

TOKEN_DEL_BOT = "Obv nascosto qui su github"
...
async def gestione_messaggi(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat == CHAT_ID_GRUPPO:
        ...
        if mex.photo and "#vendo" in description:
